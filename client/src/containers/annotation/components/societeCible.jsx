...
class SocieteCible extends React.Component {
    /**
    ...
    render() {
        ...
        const Menu = (
            ...
            >
                <HeaderMainQuest onHandleBack={ this.props.onHandleBack } title="Société cible" />
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(SocieteCible));
